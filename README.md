...
Continue developing this project in the [Lovable editor](https://lovable.dev/projects/433782a7-6db6-45e4-9185-9a1feabbcdfd).
...
npm run dev
```
>>>>>>> 2a30805 (Projeto parte do professor)
